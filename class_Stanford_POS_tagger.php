...
class Stanford_POS_Tagger
	...
	*/
  	private $model = 'tagger/models/english-left3words-distsim.tagger'; // 96.97% accuracy - fast

	////////////////////////////////////////////////////////////////////////////
	// Java variables
	////////////////////////////////////////////////////////////////////////////
	private $java_path = '/Library/Internet Plug-Ins/JavaAppletPlugin.plugin/Contents/Home/bin/java'; // the command to run java
	private $java_options = array(); // array of java switch options
	private $jar = 'tagger/stanford-postagger-3.5.0.jar'; // the jar to use located in $path
	private $path = 'tagger/';	// path to where the standford postagger directory resides
